...
const roleConfig: Record<AppRole, { icon: typeof User; label: string; color: string }> = {
  resident: { icon: User, label: "Resident", color: "text-primary" },
  admin: { icon: Shield, label: "Apartment Head", color: "text-warning" },
  technician: { icon: Wrench, label: "Technician", color: "text-success" },
};
